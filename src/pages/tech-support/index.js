...
class TechSupportScreen extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      prevProps.contactForm.isTechFormSuccessful === false &&
      contactForm.isTechFormSuccessful === true
    ) {
      this.setState(() => {
      ...
      <View style={styles.container}>
        ...
        <ScrollView>
          <Text style={styles.contactText}>
            If you’re having an issue with your mobile application, please don’t
            hesitate to contact us.
            {'\n'}
            {'\n'}
            Our Technical Support Team is here to support you. Complete the form
