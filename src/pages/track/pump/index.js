...
class PumpCards extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      ...
      if (this.props.tab.trackActiveTab === 'Pump') {
        /// FETCH ALARA HERE
        this.fetchAlarmValue(activeBaby);
      }
    }
...
const mapDispatchToProps = {
  dispatchPumpListing: data => handlePumpListing(data),
  dispatchPumpDelete: data => handlePumpDelete(data),
  dispatchEditPump: data => EDIT_GET_DATA_PUMP(data),
